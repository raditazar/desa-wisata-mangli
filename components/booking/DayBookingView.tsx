...
export default function DayBookingView({ initialApiPackages }: { initialApiPackages?: any[] }) {
  ...
  const comingSoonPkg = tourPackages.find((p) => p.id === "coming-soon")!;
  const liveInPkg = tourPackages.find((p) => p.id === "live-in")!;
